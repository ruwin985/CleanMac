...
struct StorageItem: Identifiable, Hashable {
    ...
    var isSafeForOneClickCleanup: Bool {
        ...
        var safePrefixes = [
            ...
            home + "/Library/Caches/vite",
            home + "/Library/Caches/turbo",
            home + "/Library/Caches/next-swc",
            ...
            home + "/Library/Application Support/UnityHub/Cache",
            ...
            home + "/Library/Application Support/Charles/Cache",
